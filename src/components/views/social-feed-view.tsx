...
export function SocialFeedView({
  ...
  const fetchSuggestedUsers = useCallback(async () => {
    ...
    try {
      // Use leaderboard API to get top users as suggestions
      ...
      // Filter out current user and map to SuggestedUser
  ...
  const handleFollowToggle = async (
    ...
    try {
      ...
      // Re-fetch feed to reflect new follow
      fetchFeed(1);
    } catch {
    ...
    <div className="min-h-screen px-4 py-6 max-w-6xl mx-auto">
      ...
      <Tabs defaultValue="following" className="mt-4">
                    ...
                    {suggestedUsers.map((user, index) => (
                      ...
                      >
                        <Card className="w-28 p-3 flex flex-col items-center gap-2 border border-border/50 hover:border-orange-200 dark:hover:border-orange-800/50 transition-colors">
                          ...
                          >
                            {user.avatarUrl ? (
                              <img
                                src={user.avatarUrl}
                                alt={user.username}
                                className="w-12 h-12 rounded-full object-cover ring-2 ring-orange-200 dark:ring-orange-800/50"
                                onError={(e) => {
                            ...
                            <div
                              className={`w-12 h-12 rounded-full bg-gradient-to-br from-orange-400 to-amber-500 flex items-center justify-center text-white font-bold text-sm ${
                          ...
                          <button
                            onClick={() => handleCreatorClick(user.id)}
                            className="text-xs font-medium text-center truncate max-w-full hover:text-orange-500 transition-colors"
                          >
                            @{user.username}
                          </button>
                          ...
                          <Button
                            ...
                            className={`h-6 text-[10px] px-2.5 rounded-full gap-0.5 ${
                              user.isFollowing
            ...
            {isLoadingFeed ? (
              ...
              >
                ...
                <p className="text-muted-foreground text-sm max-w-md mx-auto mb-6">
                  Follow creators to see their videos here. The more creators
                  you follow, the more personalized your feed becomes.
                </p>
                <Button
        ...
        <TabsContent value="discover">
          ...
          >
            <motion.div
              className="w-24 h-24 rounded-3xl bg-gradient-to-br from-orange-400 to-amber-500 flex items-center justify-center shadow-lg shadow-orange-500/20 mb-6"
            ...
            <p className="text-muted-foreground text-sm max-w-md mb-8">
              Explore trending videos, top creators, and fresh content from the
              community. Find your next favorite creator to follow.
            </p>
            <Button
              size="lg"
              className="gap-2 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white shadow-lg shadow-orange-500/20 h-12 px-8"
              onClick={() => onNavigate('explore')}
            >
