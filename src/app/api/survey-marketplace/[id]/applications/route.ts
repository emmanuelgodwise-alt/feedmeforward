...
// GET /api/survey-marketplace/[id]/applications — List all applications for a listing (creator only)
export async function GET(
  ...
  try {
    ...
    console.error('GET /api/survey-marketplace/[id]/applications error:', error);
