...
// POST /api/focus-groups/[id]/apply — User applies to a focus group listing
export async function POST(
  ...
  try {
    ...
    const existingApplication = await db.focusGroupApplication.findUnique({
      where: {
    ...
    const application = await db.focusGroupApplication.create({
      data: {
        listingId: id,
        applicantId: userId,
    ...
    console.error('POST /api/focus-groups/[id]/apply error:', error);
